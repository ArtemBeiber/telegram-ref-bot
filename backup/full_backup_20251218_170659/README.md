...
- **Дата создания:** 2025-12-18 17:06:59
...
│   ├── referral_orders_20251218_170659.db
│   └── referral_orders_<cabinet>_20251218_170659.db
├── docs/              # Документация
│   ├── FINAL_SETUP.md
│   └── QUICK_SETUP.md
├── scripts/           # Скрипты
...
4. Восстановите базы данных из `database/` используя скрипт `restore.py`:
   ```bash
   python restore.py --backup database/referral_orders_20251218_170659.db
   python restore.py --backup database/referral_orders_<cabinet>_20251218_170659.db
   ```
