...
- **Дата создания:** 2025-12-18 20:41:28
...
│   ├── referral_orders_20251218_204126.db
│   └── referral_orders_<cabinet>_20251218_204126.db
├── docs/              # Документация
│   ├── FINAL_SETUP.md
│   └── QUICK_SETUP.md
├── scripts/           # Скрипты
...
git add backup/full_backup_20251218_204126/
...
4. Восстановите базы данных из `database/` используя скрипт `restore.py`:
   ```bash
   python restore.py --backup database/referral_orders_20251218_204126.db
   python restore.py --backup database/referral_orders_<cabinet>_20251218_204126.db
   ```
